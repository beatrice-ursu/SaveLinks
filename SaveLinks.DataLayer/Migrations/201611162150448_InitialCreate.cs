namespace SaveLinks.DataLayer.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Person", "UpdatedBy_Id", "dbo.AspNetUsers");
            DropForeignKey("dbo.Person", "CreatedBy_Id", "dbo.AspNetUsers");
            ...
            DropIndex("dbo.Person", new[] { "UpdatedBy_Id" });
            DropIndex("dbo.Person", new[] { "CreatedBy_Id" });
